...
#endif
#define MULTIMODULE_DSM_CLONED_RAW(moduleIdx)   (isModuleMultimodule(moduleIdx) && g_model.moduleData[moduleIdx].multi.rfProtocol == MODULE_SUBTYPE_MULTI_DSM2) ? (uint8_t) 0 : HIDDEN_ROW
